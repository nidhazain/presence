...
class HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    dashboardData = DashboardService.fetchDashboardData() as Future<DashboardData>;
  }
    ...
    try {
      ...
      setState(() {
        ...
        if (parsedDate != null) {
          ...
          shiftSubtitle = dateStr; // fallback if parsing fails
        }
      });
    } catch (e) {
...
class DashboardData {
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    return DashboardData(
      ...
      date: json['date'],
      attendanceGraphData: List<Map<String, dynamic>>.from(
          json['attendance_graph_data']),
    );
  }
}
